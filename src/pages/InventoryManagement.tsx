  ...
  return (
    <div className="space-y-8">
      <div className="mb-8">
        ...
        <p className="text-white/70">Track and manage hotel inventory, supplies, and stock levels.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <DataCard title="Inventory Items" icon={<Package className="h-5 w-5 text-white" />}>
              ...
              {inventory.map((item) => (
                <div key={item.id} className="p-4 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-colors">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-3">
                    <div>
                      <p className="text-white/70 text-sm">Current Stock</p>
                      <p className="text-white font-semibold">{item.stock}</p>
                    </div>
                    <div>
                      <p className="text-white/70 text-sm">Min Stock</p>
                      <p className="text-white font-semibold">{item.minStock}</p>
                    </div>
                    <div>
                      <p className="text-white/70 text-sm">Unit Price</p>
        ...
        <div className="space-y-6">
          <DataCard title="Categories" icon={<TrendingUp className="h-5 w-5 text-white" />}>
          ...
          <DataCard title="Alerts" icon={<AlertTriangle className="h-5 w-5 text-white" />}>
            <div className="space-y-3">
              <div className="p-3 bg-red-400/10 border border-red-400/20 rounded-lg">
                ...
                <p className="text-white/70 text-sm">2 items need immediate restocking</p>
              </div>
              ...
              <div className="p-3 bg-yellow-400/10 border border-yellow-400/20 rounded-lg">
                ...
                <p className="text-white/70 text-sm">1 item below minimum threshold</p>
              </div>
            </div>
          </DataCard>

          <DataCard title="Quick Actions" icon={<RefreshCw className="h-5 w-5 text-white" />}>
            <div className="space-y-3">
          ...
          <DataCard title="Summary" icon={<Package className="h-5 w-5 text-white" />}>
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-white font-semibold">$47,900</span>
              </div>
              <div className="flex justify-between items-center">
